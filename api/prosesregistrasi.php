...
if (!$cek) {
    die("Prepare gagal (cek user): " . $conn->error . " — Pastikan tabel 'tbl_user' ada di database.");
}
...
if (!$stmt) {
    die("Prepare gagal (insert): " . $conn->error . " — Pastikan kolom tbl_user: id, username, email, password, role.");
}
